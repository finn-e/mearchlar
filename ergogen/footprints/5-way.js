...
//
//  Note that because the center pin is Y0 on both sides, there is no associated jumper pad
...
//
// Pinout and schematiX3:
//  https://nicekeyboards.com/doX3/nice-view/pinout-schematic
//
// Params:
...
//    X2_trace_width: default is 0.250mm
//      allows to override the X2 trace width. Not recommended to go below 0.25mm (JLCPC
//      min is 0.127mm).
//    signal_trace_width: default is 0.250mm
//      allows to override the trace width that connects the jumper pads to the X0, X1,
//      and X3 pins. Not recommended to go below 0.15mm (JLCPC min is 0.127mm).
...
module.exports = {
  params: {
    ...
    X0: { type: 'net', value: 'X0' },
    X1: { type: 'net', value: 'X1' },
    Y0: { type: 'net', value: 'Y0' },
    X2: { type: 'net', value: 'X2' },
    X3: { type: 'net', value: 'X3' },
  },
  body: p => {
    let dst_nets = [
      p.X0,
    ...
    if (p.invert_labels_position) {
      if(p.reversible && !p.invert_jumpers_position) {
        ...
        label_Y0_offset = 0;
        labels_offset = label_Y0_offset;
      }
    } else {
      if(p.reversible && p.invert_jumpers_position) {
        labels_offset = 1.62 + label_Y0_offset;
      }
    }
  ...
  (footprint "ceoloide:display_nice_view"
    ...
    (fp_text user "${dst_nets[2].name}" (at 0.15 ${14.75 + label_Y0_offset} ${90 + p.r}) (unlocked yes) (layer "F.SilkS")
      (effects (font (size 1 1) (thickness 0.15)) (justify ${!p.invert_labels_position ? "right" : "left"}))
    )
    ...
    (fp_text user "${p.reversible ? dst_nets[2].name : dst_nets[2].name}" (at 0.15 ${14.75 + label_Y0_offset} ${90 + p.r}) (unlocked yes) (layer "B.SilkS")
      (effects (font (size 1 1) (thickness 0.15)) (justify ${!p.invert_labels_position ? "left" : "right"} mirror))
    )
    ...
    (pad "5" thru_hole oval (at 5.08 16.7 ${270 + p.r}) (size 1.7 1.7) (drill 1) (layers "*.Cu" "*.Mask") ${socket_nets[4].str})

    (fp_line (start -6.41 15.37) (end -6.41 18.03) (layer Dwgs.User) (stroke (width 0.12) (type solid)))
    (fp_line (start 6.41 18.03) (end -6.41 18.03) (layer Dwgs.User) (stroke (width 0.12) (type solid)))
    (fp_line (start 6.41 15.37) (end 6.41 18.03) (layer Dwgs.User) (stroke (width 0.12) (type solid)))
    (fp_line (start 6.41 15.37) (end -6.41 15.37) (layer Dwgs.User) (stroke (width 0.12) (type solid)))
    )
    `
  ...
  (segment (start ${p.eaxy(-2.54, 16.7)}) (end ${p.eaxy(-2.54, 18.45)}) (width ${p.X2_trace_width}) (layer "F.Cu") (net ${jumpers_front_bottom[1].index}))
  ...
  (segment (start ${p.eaxy(2.54, 16.7)}) (end ${p.eaxy(2.54, 18.45)}) (width ${p.X2_trace_width}) (layer "B.Cu") (net ${jumpers_back_bottom[3].index}))
  ...
  (segment (start ${p.eaxy(-2.54, 16.7)}) (end ${p.eaxy(-2.54, 14.95)}) (width ${p.X2_trace_width}) (layer "F.Cu") (net ${jumpers_front_top[1].index}))
  ...
  (segment (start ${p.eaxy(2.54, 16.7)}) (end ${p.eaxy(2.54, 14.95)}) (width ${p.X2_trace_width}) (layer "B.Cu") (net ${jumpers_back_top[3].index}))
